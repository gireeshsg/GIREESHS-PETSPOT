...
const Rabbit = () => {
  ...
  const fetchRabbitProducts = async () => {
    setLoading(true);
    try {
      const response = await axios.get(
        "http://localhost:5000/user/products/category/Rabbit",
  ...
  const handleLogin = () => {
    ...
    fetchRabbitProducts(); // Refetch products to update cart state
  };
    ...
    <div>
        ...
        >
          <div className="carousel-item">
            <img src="https://cdn.pixabay.com/photo/2014/06/21/08/43/rabbit-373691_1280.jpg" alt="Book 1" />
            <img src="https://media.gettyimages.com/id/509108921/photo/three-children-with-rabbit-sitting-on-a-meadow.jpg?s=612x612&w=0&k=20&c=6CenChVhVi57u9i8d5mo9exScJna1AbeMw4gFvnbR4Q=" alt="Book 2" />
            <img src="https://media.gettyimages.com/id/1172642986/photo/little-fluffy-bunny.jpg?s=612x612&w=0&k=20&c=K33rsyDH5eBnpNTgzzandfTIP1Gh91wcBLa84AvflJw=" alt="Book 3" />
          </div>
          <div className="carousel-item">
