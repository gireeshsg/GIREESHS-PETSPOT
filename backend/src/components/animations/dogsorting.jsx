...
function SortingOptionsdog({ isOpen, onClose }) {
    ...
    return (
        <div className={`sorting-option ${isOpen ? 'open' : 'closed'} ${fadeIn ? 'fade-in' : ''}`}>
            ...
            <div className="sorting-container">
                ...
                {/* Price Sort Options */}
                <div className="section price-sort-section">
    <h3 className="section-title">Sort By Price</h3>
    <div className="radio-group">
        <label className="custom-radio">
            <input 
                ...
                name="priceSort" 
                value="lowToHigh" 
                checked={sortingOptions.priceSort === 'lowToHigh'} 
        ...
        <label className="custom-radio">
            <input 
                ...
                name="priceSort" 
                value="highToLow" 
                checked={sortingOptions.priceSort === 'highToLow'} 
                onChange={handlePriceSortChange} 
            />
            <span className="radio-checkmark"></span>
            Price: High to Low
...
export default SortingOptionsdog;
